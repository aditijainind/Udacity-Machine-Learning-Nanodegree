...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = str(waypoint) + '_' + str(inputs['left']) + '_' + str(inputs['right']) + '_' + str(inputs['oncoming']) + '_' + str(inputs['light'])
    ...
    def choose_action(self, state):
        ...
        # When learning, choose a random action with 'epsilon' probability
            ...
            randomQuantity = random.random()
            if randomQuantity <= self.epsilon:
                action = random.choice([None, 'forward', 'left', 'right'])
        # Otherwise, choose an action with the highest Q-value for the current state
                ...
                action = random.choice(maxValueList)
...
def run():
    ...
    sim.run(n_test=100, tolerance=0.0)
